...
<head>
	...
	<title>Agregar desde Portatiles</title>
	<style>
    	body {
...
<a href="<?php echo e(route('categoria', ['nombre' => 'portatiles'])); ?>">Ver productos de Portatiles</a>
 <a href="<?php echo e(route('index')); ?>" class="boton-volver">Volver al listado general</a>
...
<div class="form-container">
	<h1>Crear Producto desde Portatiles</h1>

	<form action="<?php echo e(route('guardarDesdePortatiles')); ?>" method="POST" enctype="multipart/form-data">
    	<?php echo csrf_field(); ?>
...
<?php endif; ?>
	...
	<input type="text" name="nombre" id="nombre" placeholder="Nombre del producto" value="<?php echo e(old('nombre')); ?>" required>
        	</div>

        	<div class="form-group">
            	<label for="precio">Precio</label>
	<input type="number" step="0.01" name="precio" id="precio" placeholder="Precio" value="<?php echo e(old('precio')); ?>" required>
        	</div>
...
<?php /**PATH /home/usuario/tienda2/resources/views/productos_portatiles.blade.php ENDPATH**/ ?>