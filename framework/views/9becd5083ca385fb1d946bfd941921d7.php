...
<a href="<?php echo e(route('categoria', ['nombre' => 'smartphones'])); ?>">Ver productos de Smartphones</a>
...
<div class="form-container">
	<h1>Crear Producto desde Smartphones</h1>

	<form action="<?php echo e(route('guardarDesdeSmartphones')); ?>" method="POST" enctype="multipart/form-data">
    	<?php echo csrf_field(); ?>
    	<input type="hidden" name="categoria_id" value="5">
...
<?php /**PATH /home/usuario/tienda2/resources/views/productos_smartphones.blade.php ENDPATH**/ ?>