...
<head>
	...
	<title>Agregar desde Ordenadores</title>
	<style>
    	body {
...
<a href="<?php echo e(route('categoria', ['nombre' => 'ordenadores'])); ?>">Ver productos de Ordenadores</a>
...
<div class="form-container">
	<h1>Crear Producto de Ordenadores</h1>

	<form action="<?php echo e(route('guardarDesdeOrdenadores')); ?>" method="POST" enctype="multipart/form-data">
    	<?php echo csrf_field(); ?>
...
<?php /**PATH /home/usuario/tienda2/resources/views/productos_ordenadores.blade.php ENDPATH**/ ?>