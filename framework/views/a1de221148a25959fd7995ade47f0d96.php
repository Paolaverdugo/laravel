...
<header>
	...
	<div class="header-nav">
    	<select onchange="window.location.href=this.value;">
        	...
        	<option value="<?php echo e(url('categoria/portatiles')); ?>">Portátiles</option>
        	<option value="<?php echo e(url('categoria/ordenadores')); ?>">Ordenadores</option>
        	<option value="<?php echo e(url('categoria/perifericos')); ?>">Periféricos</option>
        	<option value="<?php echo e(url('categoria/almacenamiento')); ?>">Almacenamiento</option>
        	<option value="<?php echo e(url('categoria/smartphones')); ?>">Smartphones</option>
...
<section>
	<div class="nueva-fila">
    	<div class="producto-estatico">
       	<img src="<?php echo e(asset('ahorro2.png')); ?>" alt="Ahorro" style="max-width: 100%; height: auto;">
    	</div>
	</div>
</section>
...
<section class="lo-que-no-puedes-perderte">
	...
	<div class="imagenes-perdidas">
    	<div>
        	<img src="<?php echo e(asset('movil2.png')); ?>" alt="Móviles">
    	</div>
    	<div>
        	<img src="<?php echo e(asset('almacenamiento.png')); ?>" alt="Pendrives">
    	</div>
    	<div>
        	<img src="<?php echo e(asset('teclados.png')); ?>" alt="Teclados">
    	</div>
	</div>
</section>
...
<section class="ventajas-compras">
	<div class="tarjetas">
    	<div class="tarjeta">
        	<img src="<?php echo e(asset('fotos_pequeñas/oferta.png')); ?>" alt="Ofertas especiales">
        	<p>Ofertas especiales todo el año</p>
    	</div>
    	<div class="tarjeta big">
        	<img src="<?php echo e(asset('fotos_pequeñas/devolucion.webp')); ?>" alt="Devolución gratuita">
        	<p>Devolución gratuita sin complicaciones</p>
    	</div>
    	<div class="tarjeta big">
        	<img src="<?php echo e(asset('fotos_pequeñas/pedidos.webp')); ?>" alt="Envío rápido">
        	<p>Recibe tu pedido en 48h</p>
    	</div>
    	<div class="tarjeta big">
        	<img src="<?php echo e(asset('fotos_pequeñas/envios.webp')); ?>" alt="Envío gratuito">
        	<p>Envío gratis a partir de 50€</p>
    	</div>
    	<div class="tarjeta big">
        	<img src="<?php echo e(asset('fotos_pequeñas/garantia.webp')); ?>" alt="Garantía devolución">
...
<section style="margin: 60px 20px;">
	<div class="contenedor-categorias">
    	<a href="<?php echo e(url('categoria/almacenamiento')); ?>" class="categoria">
        	<img src="<?php echo e(asset('minifotos/dc.png')); ?>" alt="dc">
        	<div class="overlay"><span>+</span></div>
    	</a>
    	<a href="<?php echo e(url('categoria/smartphones')); ?>" class="categoria">
        	<img src="<?php echo e(asset('minifotos/movil.png')); ?>" alt="movil">
        	<div class="overlay"><span>+</span></div>
    	</a>
    	<a href="<?php echo e(url('categoria/ordenadores')); ?>" class="categoria">
        	<img src="<?php echo e(asset('minifotos/ordenador.png')); ?>" alt="ordenador">
        	<div class="overlay"><span>+</span></div>
    	</a>
    	<a href="<?php echo e(url('categoria/portatiles')); ?>" class="categoria">
        	<img src="<?php echo e(asset('minifotos/pc.png')); ?>" alt="pc">
        	<div class="overlay"><span>+</span></div>
    	</a>
    	<a href="<?php echo e(url('categoria/perifericos')); ?>" class="categoria">
        	<img src="<?php echo e(asset('minifotos/teclado.png')); ?>" alt="teclado">
        	<div class="overlay"><span>+</span></div>
    	</a>
	</div>
</section>
...
<a href="<?php echo e(url('/')); ?>" class="btn-volver-inicio">Volver a inicio</a>
...
<?php /**PATH /home/usuario/tienda2/resources/views/productos.blade.php ENDPATH**/ ?>