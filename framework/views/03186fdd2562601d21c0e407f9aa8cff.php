...
<div class="container">
    ...
    <form action="<?php echo e(route('update', $producto->id)); ?>" method="POST" enctype="multipart/form-data">
  ...
  <?php echo csrf_field(); ?>
    ...
    <div class="form-grid">
        ...
        <div>
            ...
            <input type="number" id="precio" name="precio" value="<?php echo e($producto->precio); ?>" step="0.01" required>
        </div>
...
<div>
    ...
    <div class="imagen-actual">
        ...
        <?php if($producto->imagen): ?>
            <img src="<?php echo e(asset($producto->imagen)); ?>" alt="Imagen actual del producto">
        <?php else: ?>
            <p>Sin imagen</p>
        <?php endif; ?>
    </div>
...
<?php /**PATH /home/usuario/tienda2/resources/views/editar_producto.blade.php ENDPATH**/ ?>